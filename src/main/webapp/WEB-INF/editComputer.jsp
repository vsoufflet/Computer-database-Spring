...
<section id="main">
	...
	<h1><spring:message code="editComputerTitle"/></h1>
	...
	<form:form action="update?id=${computerDTO.id}" method="POST" modelAttribute="computerDTO">
		<fieldset>
			<div class="clearfix">
				...
				<div class="input">
					...
					<form:errors path="name"><spring:message code="emptyNameError"/></form:errors>
			...
			<div class="clearfix">
				...
				<div class="input">
					...
					<form:errors path="introduced"><spring:message code="dateFormatError"/></form:errors>
			...
			<div class="clearfix">
				...
				<div class="input" >
					...
					<form:errors path="discontinued"><spring:message code="dateFormatError"/></form:errors>
					<span class="help-inline"><spring:message code="datePattern"/></span>
				</div>
			</div>
			<div class="clearfix">
		...
		<div class="actions">
		<input type="submit" value=<spring:message code="saveButton"/> class="btn primary">
			<spring:message code="or"/> <a href="dashboard" class="btn"><spring:message code="cancelButton"/></a>
		</div>
	</form:form>
</section>
